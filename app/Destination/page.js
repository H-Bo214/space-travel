...
export default function Destination({ name, description, image, distance, travel }) {
  return (
    <section className={styles.container}>
      <section>
        <Image className={styles.image} src={image} width={445} height={445} alt={name} />
      </section>
      <article className={styles.destinationContainer}>
        ...
        <section className={styles.detailsContainer}>
          <section>
            ...
            <p className={`${styles.distanceTravel} ${bellefair.className}`}>{distance}</p>
          </section>
          <section>
            <h3 className={`${styles.detailsHeading} ${barlowCondensed.className}`}>
              EST. TRAVEL TIME
            </h3>
            <p className={`${styles.distanceTravel} ${bellefair.className}`}>{travel}</p>
          </section>
        </section>
      </article>
    </section>
